...
default value is defined [here](src/payments/pricing.rs#L85): `interval` within `LinearPricingOffer`).
...
`5sec`. Starting point for `timeout` is controlled via [CLI](src/market/negotiator/factory.rs#L27)
